...
// Niveau 1 : additions simples 1-9, 25s       → très facile
// Niveau 2 : additions simples 1-9, 20s
// Niveau 3 : soustractions, 18s
// Niveau 4 : soustractions, 15s               → modéré
// Niveau 5 : multiplications, 15s             → difficile
// Niveau 6 : opérations mixtes (+/-), 12s     → très difficile
// Progression de difficulté :
// Niveau 1 : 5 questions, 30s, mode 1 (+/- simples)      → très facile
// Niveau 2 : 5 questions, 22s, mode 1
// Niveau 3 : 6 questions, 18s, mode 2 (×/÷ simples)
// Niveau 4 : 6 questions, 15s, mode 2
// Niveau 5 : 7 questions, 12s, mode 3 (mixte)            → difficile
// Niveau 6 : 7 questions, 9s,  mode 4 (complexe)         → très difficile
const LEVELS = [
  { questions: 5, seconds: 30, mode: 1 },
  { questions: 5, seconds: 22, mode: 1 },
  { questions: 6, seconds: 18, mode: 2 },
  { questions: 6, seconds: 15, mode: 2 },
