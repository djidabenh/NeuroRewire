...
// Niveau 1 : comparer 2 nombres (2-40), 20s   → très facile
// Niveau 2 : comparer 2 nombres (2-40), 15s
// Niveau 3 : comparer sommes (a+b vs c+d), 18s
// Niveau 4 : comparer sommes, 14s             → modéré
// Niveau 5 : comparer soustractions, 15s      → difficile
// Niveau 6 : comparer expressions mixtes, 12s → très difficile
// Progression de difficulté :
// Niveau 1 : 5 questions, 25s, mode 1 (couleurs)         → très facile
// Niveau 2 : 5 questions, 18s, mode 1 (couleurs)
// Niveau 3 : 6 questions, 16s, mode 2 (formes)
// Niveau 4 : 6 questions, 13s, mode 2 (formes)
// Niveau 5 : 7 questions, 12s, mode 3 (mixte)            → difficile
// Niveau 6 : 7 questions, 9s,  mode 4 (complexe)         → très difficile
const LEVELS = [
  { questions: 5, seconds: 25, mode: 1 },
  { questions: 5, seconds: 18, mode: 1 },
  { questions: 6, seconds: 16, mode: 2 },
  { questions: 6, seconds: 13, mode: 2 },
  { questions: 7, seconds: 12, mode: 3 },
  { questions: 7, seconds: 9,  mode: 4 }
];
