...
const translations = {
  ar: {
    ...
    score_type_label: "نوع النتيجة (اختياري)",
    score_value_label: "قيمة النتيجة (اختياري)",
  ...
  fr: {
    ...
    score_type_label: "Type de score (optionnel)",
    score_value_label: "Valeur du score (optionnel)",
  ...
  en: {
    ...
    score_type_label: "Score type (optional)",
    score_value_label: "Score value (optional)",
...
function applyTranslations(lang) {
  ...
  setLabelText('label[for="reg-familyname"]', t.first_name);
  setLabelText('label[for="reg-givenname"]', t.last_name);
  ...
  setLabelText('label[for="reg-stroke-score-type"]', t.score_type_label);
  setLabelText('label[for="reg-stroke-score-value"]', t.score_value_label);

  document.getElementById("reg-familyname").placeholder = t.first_name_placeholder;
  document.getElementById("reg-givenname").placeholder = t.last_name_placeholder;
  ...
  const errorTexts = {
  "error-reg-familyname": t.hint_firstname,
  "error-reg-givenname": t.hint_lastname,
