...
// Niveau 1 : 6 fruits, vitesse lente 1.0, spawn 1500ms  → très facile
// Niveau 2 : 8 fruits, vitesse 1.4, spawn 1300ms
// Niveau 3 : 10 fruits, vitesse 1.8, spawn 1100ms
// Niveau 4 : 14 fruits, vitesse 2.2, spawn 950ms        → modéré
// Niveau 5 : 16 fruits, vitesse 2.6, spawn 820ms        → difficile
// Niveau 6 : 20 fruits, vitesse 3.2, spawn 700ms        → très difficile
const LEVELS = [
  // Niveau 1 : 6 fruits, vitesse 1.0, spawn toutes 1500ms   → très facile
  // Niveau 2 : 8 fruits, vitesse 1.5, spawn toutes 1200ms
  // Niveau 3 : 10 fruits, vitesse 2.0, spawn toutes 1000ms
  // Niveau 4 : 14 fruits, vitesse 2.5, spawn toutes 850ms
  // Niveau 5 : 16 fruits, vitesse 3.0, spawn toutes 700ms   → difficile
  // Niveau 6 : 20 fruits, vitesse 3.8, spawn toutes 560ms   → très difficile
  { fruitsToSpawn: 6,  speed: 1.0, spawnEvery: 1500 },
  { fruitsToSpawn: 8,  speed: 1.5, spawnEvery: 1200 },
  { fruitsToSpawn: 10, speed: 2.0, spawnEvery: 1000 },
  { fruitsToSpawn: 14, speed: 2.5, spawnEvery: 850  },
  { fruitsToSpawn: 16, speed: 2.0, spawnEvery: 950  },
  { fruitsToSpawn: 20, speed: 2.4, spawnEvery: 850  }
];
